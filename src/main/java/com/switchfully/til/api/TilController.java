...
public class TilController {
    ...
    public Til addTilWithPostman(@RequestBody TilRequest newKnowledge) {
    ...
    public String addTilWithUI(TilRequest newKnowledge) {
        tilService.addTil(newKnowledge);
        return "Thank you " + newKnowledge.getPerson() + ", your #TIL has been added";
    }

    @DeleteMapping("/{id}")
    public String deleteTil(@PathVariable UUID id) {
    ...
    public String addLikeWithUI(Til newLike) {
        System.out.println(newLike.getPerson());
        return "OK";
    }
}
